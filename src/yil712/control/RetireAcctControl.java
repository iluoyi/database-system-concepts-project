...
public class RetireAcctControl {
	private Connection con = null;
	
	public RetireAcctControl() {
...
//		insert into invest_transaction values ('T000045', 'VC', 100)
		...
		String query1 = "insert into transaction values('" + newTransID + "', '" + accountID + 
							"', '" + amount + "', TO_DATE('" + sqlDate + "','YYYY-MM-DD'), '8')";
...
//		System.out.println(query2);
	...
	//			insert into invest_transaction values ('T000049', 'VC', '10')
				...
				String query1 = "insert into transaction values('" + newTransID + "', '" + accountID + 
									"', '" + amount + "', TO_DATE('" + sqlDate + "','YYYY-MM-DD'), '9')";
...
//		group by account_num, invest_symbol
	...
	public double getRetireAccountBalance(String accountID) {
		String query = "select balance from retire_account where account_num = '" + accountID + "'";
		double balance = 0;
