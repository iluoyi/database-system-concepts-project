...
public class BuyInvestmentUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BuyInvestmentUI frame = BuyInvestmentUI.getInstance("AAN", "A000006");
	...
	private static BuyInvestmentUI singleton = null;	// singleton
	public static BuyInvestmentUI getInstance(String symbol, String accountNum) {
		if (singleton == null) {
			singleton = new BuyInvestmentUI(symbol, accountNum);
		} else {
			symbolStr = symbol;
	 ...
	 * Create the frame.
	 */
	private BuyInvestmentUI(String symbol, String accountNum) {
		symbolStr = symbol;
		accountID = accountNum;
		setResizable(false);
